        ...
        return `
            <div class="div-card">
                ...
                <div class="div-texto">
                    ...
                    <button onclick="adicionarLivros${urlImagem}" class= "rounded-md flex justify-center w-full h-6 p-1 border border-blue-500"><i class="text-blue-500 py-1 fa-solid fa-plus"></i></button>
                </div>
            </div>
